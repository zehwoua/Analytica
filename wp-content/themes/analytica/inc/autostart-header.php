<div id="autostart_header" class="clearfix">
	<div class="logo">
		<a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/autostart/autostart-banner.png" width="400" alt="AutoStart" title="AutoStart"></a>
	</div>
